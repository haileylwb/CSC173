...
extern DFA* DFA_for_contains_dfa();

extern DFA* DFA_for_contains_cat();

extern DFA* DFA_for_contains_two2();

extern DFA* DFA_for_contains_evenOdd();

extern int DFA_set_initialState(DFA dfa, int i);

extern int DFA_get_initialState(DFA dfa);
